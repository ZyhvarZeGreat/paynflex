...
export default function User() {
    ...
    const fetchUsers = async () => {
      try {
        ...
        if (axios.isAxiosError(err)) {
          ...
          console.error("An unexpected error occurred while fetching users");
        }
      }
    };
  ...
  const metrics = [
    ...
    {
      title: "Active",
      value: Number(users?.totalUsers - users?.totalPendingUsers) || 0,
      icon: (
        <svg
          width="23"
          height="22"
    ...
    {
      title: "Pending",
      value: users?.totalPendingUsers || 0,
      icon: (
        <svg
          width="21"
          height="18"
    ...
    {
      title: "Suspended",
      value: users?.totalSuspendedUsers || 0,
      icon: (
        <svg
          width="21"
          height="18"
